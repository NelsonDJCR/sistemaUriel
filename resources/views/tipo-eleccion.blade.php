@extends('layouts.app')
@section('title', 'Tipo eleccion')
@section('content')
<div class="container mt-5">
    <label for="" class="p-2">Sistema Uriel/Parametrización/Tipos de elección</label>
    <div class="row p-2 text-center border shadow">
        <div class="row">
            <div class="col-12 col-md-12 col-lg-10 col-xl-9 p-2">
                <h1 class="text-blue "> <b>TIPOS DE ELECCIÓN</b> </h1>
            </div>
            <div class='col-12 col-md-12 col-lg-2 col-xl-3 p-2'>
                <button type="button"
                    class="btn btn-warning text-white mt-2 new_document modal_crear_tipoDocumento">Nuevo tipo</button>
            </div>
        </div>
    </div>
</div>
